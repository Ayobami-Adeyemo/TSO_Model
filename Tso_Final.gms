...
PARAMETER fare(h,techs)'fare prices of technology at hr h (pounds/km)';
$gdxin Input_Final.gdx
$load fare
$gdxin
;
...
spend_MTT(h,techs)       'spend on each technology in each hr pounds/hr'
total_spend_techs_MTT(techs) 'spend on each technology in a day pounds/day'
total_spend_MTT            'spend on all techs in a day, pounds/day'
...
total_spend           'spend on all techs in a week pounds/week'
...
EQUATIONS
*All equation names match the variable names,hence the same descriptions for the variables hold for the equations
